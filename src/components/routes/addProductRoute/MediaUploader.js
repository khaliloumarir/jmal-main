...
export default function MediaUploader({ media, videos, setVideos, setMedia, register }) {
    ...
    const onDrop = useCallback(acceptedFiles => {
        ...
        acceptedFiles.forEach((item) => {
            ...
            reader.onload = () => {
                ...
                const content = { data: binaryStr, size: Buffer.byteLength(binaryStr), name: metadata[0], ext: metadata[1], id: media.length + 1 }
                if (type === "video") {
    ...
    return (
        <div className="">
            <div  {...getRootProps({ style })}>
                <input {...register("Media")} {...getInputProps()} />
