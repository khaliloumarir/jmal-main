                ...
                return (
                    <form
                        ...
                        onSubmit={async (evt) => {
                            ...
                            const client = new window.telegram.TelegramClient(session, apiId, apiHash, {
                                connectionRetries: 5,
                            });
                            ...
                            const { phoneCodeHash, isCodeViaApp } = await client.sendCode({ apiHash, apiId }, number)
                ...
                return (
                    <form onSubmit={async (evt) => {
                        ...
                        try {
                            ...
                            const passwordSRPCheck = await window.telegram.helpers.getPasswordSrpCheck(passwordSrpResult, password)
